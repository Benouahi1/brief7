                ...
                <div class="col-lg-6">
				    ...
				    <div class="form-group">
                        <form action="/post" method="post" enctype="multipart/form-data">
        				 ...
        				 <input type="text" name="author" class="form-control m-2" placeholder="prix">
                         <Textarea name="body" cols="20" rows="4" class="form-control m-2" placeholder="discription"></Textarea>
